...
namespace Amaris.DependencyResolver
{
    ...
    internal class RegisterComponent : IRegisterComponent
    {
        ...
        public void RegisterType<TFrom, TTo>(bool withInterception = true) where TTo : TFrom
        {
            if (withInterception)
            {
                //this._container.RegisterType<TFrom, TTo>();
                _container.RegisterType<TFrom, TTo>(new Interceptor<InterfaceInterceptor>(), new InterceptionBehavior<ProfilingInterceptionBehavior>());
        ...
        public void RegisterTypeWithControlledLifeTime<TFrom, TTo>(bool withInterception = true) where TTo : TFrom
        {
